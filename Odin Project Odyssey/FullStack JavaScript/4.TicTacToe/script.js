...
const gameController = (function () {
  ...
  const winCon = [
    [0, 1, 2],
    [3, 4, 5],
    [6, 7, 8], // horizontal winCon
    [0, 3, 6],
    [1, 4, 7],
    [2, 5, 8], // vertical winCon
    [0, 4, 8],
    [2, 4, 6], // diagonal winCon
  ];
  ...
  const switchPlayer = () => {
    activePlayer =
      activePlayer === gameController.players[0]
  ...
  function playGame() {
    ...
    playersInfos.innerHTML = `<b>Player X:</b><br>${
      gameController.players[0].name
    }<br><br><b>Player O:</b><br>${
      gameController.players[1].name
    }<br><br><b>First player is: ${gameController.getActivePlayer().name}</b>`;
